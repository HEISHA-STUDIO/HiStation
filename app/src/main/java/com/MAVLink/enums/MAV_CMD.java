...
public class MAV_CMD {
   ...
   public static final int MAV_CMD_REQUEST_STORAGE_FORMAT = 243; /* Format one storage, internal storage or SD card. |1:SD card 2£ºInternal storage.| Reserved (all remaining params)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
