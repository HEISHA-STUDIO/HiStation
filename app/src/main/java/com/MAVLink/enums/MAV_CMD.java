...
public class MAV_CMD {
   ...
   public static final int MAV_CMD_VIDEO_STREAMING_REQUEST = 240; /* Request video streaming from a selected video source, T3 or drone. |1:T3 camera 2:Drone camera.| Reserved (all remaining params)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
