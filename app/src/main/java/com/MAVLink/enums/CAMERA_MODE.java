...
public class CAMERA_MODE {
   ...
   public static final int CAMERA_MODE_DOWNLOAD = 2; /* Camera is in image survey capture mode. It allows for camera controller to do specific settings for surveys. | */
